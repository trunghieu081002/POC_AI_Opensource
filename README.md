...
- [x] `postgres` suite with negative and restart checks; `dbt`/`airflow` have
      no suite yet — see `dpagent packs -v` for which packs are covered
...
- [ ] Acceptance suites for dbt and airflow
